...
if [ ! -f "${SENTENCEPIECE_MODEL_NAME}.model" ]; then
  ...
  spm_train --input="${UNIQ_SENTENCE_FILE}" --character_coverage 1.0 --model_prefix="${SENTENCEPIECE_MODEL_NAME}" --vocab_size=100000 --unk_id=0 --pad_id=1 --bos_id=2 --eos_id=3 --input_sentence_size=30000000 --model_type=unigram
else
